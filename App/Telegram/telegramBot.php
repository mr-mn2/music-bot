...
public function edit_markap($chat_id, $message_id,$text,$reply_markup = null)
  {
    if (is_null($reply_markup)) {
      $params = compact('chat_id', 'message_id', 'text');
    }else{
      $params = compact('chat_id', 'message_id', 'text', 'reply_markup');
    }
 ...
 public static function forceReply($selective = false)
 {
  ...
  private function sendRequest($method, $params)
  {
     ...
     //file_put_contents('resddult.txt',$this->baseURL . $method . '?' . http_build_query($params).PHP_EOL.PHP_EOL,FILE_APPEND);
  }
